                    ...
                    <div class="list-single-carousel-wrap fl-wrap" id="sec1">
                        <div class="fw-carousel fl-wrap full-height lightgallery">
                            ...
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga1-01.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga1-01.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            ...
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga2-01.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga2-01.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga3-01.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga3-01.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga4-01.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga4-01.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga5-01.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/korean/guyiga/guyiga5-01.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="list-single-main-wrapper fl-wrap" id="sec2">
                                        <div class="breadcrumbs gradient-bg  fl-wrap"><a href="Homepage">Home</a><a href="Restaurants_Category">Category</a><a href="Korean_Restaurants">Korean</a><span>Gu Yi Ga Korean Grill House</span></div>
                                        <!-- list-single-header -->
                                                ...
                                                <div class="list-single-header-item">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            ...
                                                            <h2>Gu Yi Ga Korean Grill House<span> - Hosted By </span><a href="author-single.html">Alisa Noory</a> </h2>
                                        ...
                                        <div class="box-widget-item fl-wrap">
                                            ...
                                            <div class="box-widget">
                                                <div class="map-container">
                                                    <div id="singleMap" data-latitude="15.1614238" data-longitude="120.5554148" data-mapTitle="Our Location"></div>
                                                </div>
                                                <div class="box-widget-content">
                                                    <div class="list-author-widget-contacts list-item-widget-contacts">
                                                        <ul>
                                                            <li><span><i class="fa fa-map-marker"></i> Address :</span> <a href="#">Friendship Highway Angeles City 2009</a></li>
                                                            <li><span><i class="fa fa-phone"></i> Phone :</span> <a href="#">(045) 624 6847</a></li>
