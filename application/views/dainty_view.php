                    ...
                    <div class="list-single-carousel-wrap fl-wrap" id="sec1">
                        <div class="fw-carousel fl-wrap full-height lightgallery">
                            ...
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/d1.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/d1.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            ...
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/d2.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/d2.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/d3.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/d3.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/d4.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/d4.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="assets/frontend-assets/images/restaurants/d5.jpg"   alt="">
                                    <a href="assets/frontend-assets/images/restaurants/d5.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="list-single-main-wrapper fl-wrap" id="sec2">
                                        <div class="breadcrumbs gradient-bg  fl-wrap"><a href="Homepage">Home</a><a href="Restaurants">Restaurants</a><span>Dainty</span></div>
                                        <!-- list-single-header -->
                                                ...
                                                <div class="list-single-header-item">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            ...
                                                            <h2>Dainty Asian Cuisine<span> - Hosted By </span><a href="author-single.html">Alisa Noory</a> </h2>
                                        ...
                                        <div class="box-widget-item fl-wrap">
                                            ...
                                            <div class="box-widget">
                                                <div class="map-container">
                                                    <div id="singleMap" data-latitude="15.1652129" data-longitude="120.5905364" data-mapTitle="Our Location"></div>
                                                </div>
                                                <div class="box-widget-content">
