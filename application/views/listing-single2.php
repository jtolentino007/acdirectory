...
<!-- Mirrored from citybook.kwst.net/listing-single2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 03:33:55 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
                                                ...
                                                <div class="gallery-item">
                                                    <div class="grid-item-holder">
                                                        <div class="box-item">
                                                            ...
                                                            <a href="images/all/single/2.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- 2 end -->
                                                ...
                                                <div class="gallery-item">
                                                    <div class="grid-item-holder">
                                                        <div class="box-item">
                                                            ...
                                                            <a href="images/all/single/3.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- 3 end -->
                                                ...
                                                <div class="gallery-item">
                                                    <div class="grid-item-holder">
                                                        <div class="box-item">
                                                            ...
                                                            <a href="images/all/single/4.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- 4 end -->
                                                ...
                                                <div class="gallery-item">
                                                    <div class="grid-item-holder">
                                                        <div class="box-item">
                                                            ...
                                                            <a href="images/all/single/5.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- 5 end -->
                                                ...
                                                <div class="gallery-item">
                                                    <div class="grid-item-holder">
                                                        <div class="box-item">
                                                            ...
                                                            <a href="images/all/single/6.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- 7 end -->
...
<!-- Mirrored from citybook.kwst.net/listing-single2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 03:34:24 GMT -->
</html>