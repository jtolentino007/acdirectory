...
<!-- Mirrored from citybook.kwst.net/contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 03:35:52 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="list-single-main-wrapper fl-wrap">
                                        ...
                                        <div id="contact-form">
                                            <div id="message"></div>
                                            <form  class="custom-form" action="http://citybook.kwst.net/php/contact.php" name="contactform" id="contactform">
                                                <fieldset>
